...
SKY_MESH_SUPPORT=_set_by_buildFS_
...
#WLAN Module
if [ "$SKY_MESH_SUPPORT" != y ]; then

	echo "$SKY_MESH_SUPPORT-------------------Loading wl.ko (NON MESH)---------------------------"
...
# EPON Module
test -e /lib/modules/$KERNELVER/extra/epon_stack.ko && insmod /lib/modules/$KERNELVER/extra/epon_stack.ko epon_usr_init=1 epon_read_pers=1 
...
# nfc module && associated I2C adapter
 test -e /lib/modules/$KERNELVER/kernel/drivers/nfc/nt3h1201.ko && insmod /lib/modules/$KERNELVER/kernel/drivers/nfc/nt3h1201.ko
 test -e /lib/modules/$KERNELVER/kernel/drivers/nfc/sky_i2c_soft.ko && insmod /lib/modules/$KERNELVER/kernel/drivers/nfc/sky_i2c_soft.ko
