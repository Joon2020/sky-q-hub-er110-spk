...
8. Open the browser and navigate to http://192.168.2.1  
...
7. If your PC/Mac device doesn't get an IP assigned try to assign a static IP address to it. This address must be from 192.168.2.2 to 192.168.2.255 range. You can check whether your computer sees the router by issuing ping 192.168.2.1 command.
