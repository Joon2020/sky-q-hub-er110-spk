...
/*  File automatically generated by Reggae at 15/01/2013  09:26:07   */
...
#define UBUS_UBUS_MISC_EGPHY_GPHY_OUT_IDDQ_BIAS_IDDQ_BIAS_VALUE                  ( 0x1 )
#define UBUS_UBUS_MISC_EGPHY_GPHY_OUT_IDDQ_BIAS_IDDQ_BIAS_VALUE_RESET_VALUE      ( 0x1 )
#define UBUS_UBUS_MISC_EGPHY_GPHY_OUT_DLL_EN_DLL_EN_VALUE                        ( 0x0 )
#define UBUS_UBUS_MISC_EGPHY_GPHY_OUT_DLL_EN_DLL_EN_VALUE_RESET_VALUE            ( 0x0 )
...
#define UBUS_UBUS_MISC_EGPHY_GPHY_OUT_RST_RST_VALUE_RESET_VALUE                  ( 0x0 )
...
typedef struct
{
	...
	/* Reserved */
	uint32_t reserved1 [ 3048 ] __PACKING_ATTRIBUTE_FIELD_LEVEL__ ;

	/* UBUS_SLAVE */
	UBUS_UBUS_SLAVE ubus_slave __PACKING_ATTRIBUTE_FIELD_LEVEL__ ;

	/* Reserved */
	uint32_t reserved2 [ 1012 ] __PACKING_ATTRIBUTE_FIELD_LEVEL__ ;
