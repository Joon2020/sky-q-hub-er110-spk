...
/*  File automatically generated by Reggae at 28/01/2013  08:22:47   */
...
#define BBH_RX_PM_COUNTERS_EPONTYPERROR_OFFSET ( 0x00000040 )
...
#define BBH_TX_CONFIGURATIONS_ETHTT_DDRTT_DEFAULT_VALUE                ( 0xC0 )
#define BBH_TX_CONFIGURATIONS_ETHTT_DDRTT_DEFAULT_VALUE_RESET_VALUE    ( 0xC0 )
...
typedef struct
{
	...
	/* DDR_TRANSMIT_TH */
	uint32_t ddrtt   	: 9 __PACKING_ATTRIBUTE_FIELD_LEVEL__ ;
}
__PACKING_ATTRIBUTE_STRUCT_END__
...
typedef struct
{
	...
	/* Reserved */
	uint8_t reserved1 [ 188 ] __PACKING_ATTRIBUTE_FIELD_LEVEL__ ;
...
typedef struct
{
	...
	/* Reserved */
	uint8_t reserved1 [ 39568 ] __PACKING_ATTRIBUTE_FIELD_LEVEL__ ;
