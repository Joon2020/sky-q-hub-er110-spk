...
/*  File automatically generated by Reggae at 28/01/2013  08:23:27   */
...
#else
#define RUNNER_INST_MAIN_MEM_COUNTER ( 5120 )
#endif  /* OREN */
...
#else
#define RUNNER_INST_PICO_MEM_COUNTER ( 2048 )
#endif  /* OREN */
...
{
	/* Rserved */
	uint32_t rserved2     	: 16 __PACKING_ATTRIBUTE_FIELD_LEVEL__ ;

	/* DMA_base_address */
	uint32_t dma_base     	: 6 __PACKING_ATTRIBUTE_FIELD_LEVEL__ ;
...
#else
#define RUNNER_PRED_MAIN_MEM_ENTRY_NUMBER ( 320 )
#endif  /* OREN */
...
#else
#define RUNNER_PRED_PICO_MEM_ENTRY_NUMBER ( 128 )
#endif  /* OREN */
...
typedef struct
{
	...
	/* Reserved */
	uint8_t reserved5 [ 15744 ] __PACKING_ATTRIBUTE_FIELD_LEVEL__ ;
	...
	/* Reserved */
	uint8_t reserved8 [ 380288 ] __PACKING_ATTRIBUTE_FIELD_LEVEL__ ;
