...
/*  File automatically generated by Reggae at 28/01/2013  08:22:56   */
...
/* dma or 64 buffers in dma  in the upload data RAM.  The allocation is done by defining */
/*  a base address (aligned to 128 bytes) and the number of allocated buffers.  Note tha */
/* t the memory allocation should not contain wrap around. For example, if three buffers */
/*  are needed, do not allocate buffers 30, 31 and 0.   The number of allocated CDs is t */
/* he same of data buffers - one chunk descriptor per buffer, therefore allocation in CD */
/*  RAM is defined only by offset address.    The order of peripherals within the array  */
/* is:  Ethernet 0  Ethernet 1  Ethernet 2  Ethernet 3  Ethernet 4  GPON                 */
/*****************************************************************************************/
...
typedef struct
{
	...
	/* Reserved */
	uint8_t reserved0 [ 104 ] __PACKING_ATTRIBUTE_FIELD_LEVEL__ ;
