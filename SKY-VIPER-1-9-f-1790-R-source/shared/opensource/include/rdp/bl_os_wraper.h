...
#define		BL_LILAC_IRQ_BASE		0x70
	...
	#if defined _CFE_
	 #define	BL_LOCK_SECTION(flags)		{flags = 0;if(flags == 1)flags = 0;}
	 #define  	BL_UNLOCK_SECTION(flags)	{flags = 0;if(flags == 1)flags = 0;}
	#elif defined __KERNEL__
	 #define	BL_LOCK_SECTION				local_irq_save
	 #define  	BL_UNLOCK_SECTION			local_irq_restore
	#else
	 #warning "Unspecified OS !"
	#endif
#endif
