...
typedef struct cfeflashaddrinfo
{
    int flash_sky_scratch_pad_start_blk;  /**< start of scratch pad */
    int flash_sky_scratch_pad_number_blk;
    int flash_sky_scratch_pad_length;     /**< in bytes */
    unsigned long flash_sky_scratch_pad_blk_offset;
...
} CFE_FLASH_ADDR_INFO, *PCFE_FLASH_ADDR_INFO;

#define FLASH_ADDR_INFO CFE_FLASH_ADDR_INFO
#define PFLASH_ADDR_INFO PCFE_FLASH_ADDR_INFO
