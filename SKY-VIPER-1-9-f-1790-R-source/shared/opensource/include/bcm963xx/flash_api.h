...
int flash_write_protect_serialisation_sectors(void);
#else
int flash_software_unprotect(void);
int flash_software_write_protect(void);
int flash_is_write_protected(void);
#endif
#endif /* SKY */
...
#ifdef SKY
#ifdef ENABLE_SERIALISATION_WP
    int (*fn_flash_write_protect_serialisation_sectors) (void);
#else
    int (*fn_spi_flash_software_unprotect) (void);
    int (*fn_spi_flash_software_write_protect) (void);
    int (*fn_spi_flash_is_write_protected) (void);
#endif
#endif /* SKY */
