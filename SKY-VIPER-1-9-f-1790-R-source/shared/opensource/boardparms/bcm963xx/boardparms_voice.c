...
VOICE_BOARD_PARMS_NEW g_voice_bcm963168MBV3 =
{
   "963168MBV3",   /* Base Board ID */
   {
      { SPI_DEV_1, BP_DEDICATED_PIN },   /* This SPI Device ID is mapped to SPI_SS_B1 with a dedicated pin. */
      { SPI_DEV_4, BP_GPIO_16_AL },      /* This SPI Device ID is mapped to SPI_SS_B2 with the GPIO_16_AL pin. */
      { SPI_DEV_5, BP_GPIO_17_AL }        /* This SPI Device ID is mapped to SPI_SS_B3 with the GPIO_7_AL pin. */
   },
   {
      BP_GPIO_14_AL,   /* FXS1 reset pin, mapped to the FXS1 reset pin on daughter board. */
      BP_GPIO_15_AL,   /* FXS2 reset pin, mapped to the FXS2 reset pin on daughter board. */
   ...
   BP_GPIO_35_AL,   /* DECT reset GPIO pin. */
   BP_GPIO_12_AH,    /* Relay 1 GPIO pin. */
   BP_NOT_DEFINED,  /* Relay 2 GPIO pin. */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm96818GRRG2L_BOSA =
{
   "96818GRRG2LBOSA",
   {
      {SPI_DEV_1, BP_DEDICATED_PIN },     /* This SPI Device ID is mapped to SPI_SS_B1 with the GPIO_21_AL pin. */
      {SPI_DEV_2, BP_GPIO_28_AL},     /* This SPI Device ID is mapped to SPI_SS_B2 with the GPIO_28_AL pin. */
      {SPI_DEV_3, BP_GPIO_21_AL }   /* This SPI Device ID is mapped to SPI_SS_B3 with a dedicated pin. */
   },
   {
      BP_GPIO_16_AL,    /* FXS1 reset pin, mapped to the FXS1 reset pin on daughter board. */
      BP_GPIO_15_AL,    /* FXS2 reset pin, mapped to the FXS2 reset pin on daughter board. */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968385SFU =
{
   "968385SFU",
   {
      {SPI_DEV_0,  BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B1 with a dedicated pin. */
      {SPI_DEV_0,  BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B2 with the GPIO_28_AL pin. */
      {SPI_DEV_0,  BP_NOT_DEFINED}     /* This SPI Device ID is mapped to SPI_SS_B3 with the GPIO_29_AL pin. */
   },
   {
      BP_NOT_DEFINED,    /* FXS1 reset pin, mapped to the FXS1 reset pin on daughter board. */
      BP_NOT_DEFINED,    /* FXS2 reset pin, mapped to the FXS2 reset pin on daughter board. */
   ...
   BP_NOT_DEFINED,   /* DECT reset pin, 6838G_RG doesn't support DECT */
   BP_NOT_DEFINED,   /* Relay1 control pin, 6838G_RG doesn't support relay */
   BP_NOT_DEFINED,   /* Repay2 control pin, 6838G_RG doesn't support relay */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968385ESFU =
{
   "968385ESFU",
   {
      {SPI_DEV_0,  BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B1 with a dedicated pin. */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968385SV_G =
{
   "968385SV_G",
   {
      {SPI_DEV_4, BP_GPIO_9_AL},     /* This SPI Device ID is mapped to SPI_SS_B1 with the GPIO_9_AL pin.  */
      {SPI_DEV_6, BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B2 with the GPIO_12_AL pin. */
      {SPI_DEV_6, BP_NOT_DEFINED}     /* This SPI Device ID is mapped to SPI_SS_B3. */
   },
   {
      BP_GPIO_5_AL,  /* FXS1 reset pin, mapped to the FXS1 reset pin on daughter board. */
      BP_GPIO_6_AL,  /* FXS2 reset pin, mapped to the FXS2 reset pin on daughter board. */
      BP_GPIO_7_AL,  /* FXO reset pin, mapped to the FXO reset pin on daughter board. */
   },

   BP_NOT_DEFINED,     /* DECT reset pin */
   BP_NOT_DEFINED,     /* Relay 1 GPIO pin. */
   BP_NOT_DEFINED,     /* Relay 2 GPIO pin. */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968385SV_E =
{
   "968385SV_E",
   {
      {SPI_DEV_4, BP_GPIO_9_AL},     /* This SPI Device ID is mapped to SPI_SS_B1 with the GPIO_9_AL pin.  */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968380FHGU =
{
   "968380FHGU",
   {
      {SPI_DEV_0,  BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B1 with a dedicated pin. */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968380FEHG =
{
   "968380FEHG",
   {
      {SPI_DEV_0,  BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B1 with a dedicated pin. */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968380FGGU =
{
   "968380FGGU",
   {
      {SPI_DEV_0,  BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B1 with a dedicated pin. */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968380FEGU =
{
   "968380FEGU",
   {
      {SPI_DEV_0,  BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B1, no PCM support on this board */
      {SPI_DEV_0,  BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B2, no PCM support on this board */
      {SPI_DEV_0,  BP_NOT_DEFINED}     /* This SPI Device ID is mapped to SPI_SS_B3, no PCM support on this board */
   },
   {
      BP_NOT_DEFINED,    /* FXS1 reset pin, mapped to the FXS1 reset pin on daughter board. */
      BP_NOT_DEFINED,    /* FXS2 reset pin, mapped to the FXS2 reset pin on daughter board. */
   ...
   BP_NOT_DEFINED,   /* DECT reset pin */
   BP_NOT_DEFINED,   /* Relay1 control pin */
   BP_NOT_DEFINED,   /* Repay2 control pin */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968380FSVG =
{
   "968380FSV_G",
   {
      {SPI_DEV_4, BP_GPIO_9_AL},     /* This SPI Device ID is mapped to SPI_SS_B1 with the GPIO_9_AL pin.  */
      {SPI_DEV_6, BP_GPIO_12_AL},    /* This SPI Device ID is mapped to SPI_SS_B2 with the GPIO_12_AL pin. */
      {SPI_DEV_7, BP_GPIO_67_AL}     /* This SPI Device ID is mapped to SPI_SS_B3 with the GPIO_67_AL pin. */
   },
   {
      BP_GPIO_5_AL,  /* FXS1 reset pin, mapped to the FXS1 reset pin on daughter board. */
      BP_GPIO_6_AL,  /* FXS2 reset pin, mapped to the FXS2 reset pin on daughter board. */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968380FSVE =
{
   "968380FSV_E",
   {
      {SPI_DEV_4, BP_GPIO_9_AL},     /* This SPI Device ID is mapped to SPI_SS_B1 with the GPIO_9_AL pin.  */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968380FSVGE =
{
   "968380FSV_GE",
   {
      {SPI_DEV_4, BP_GPIO_9_AL},     /* This SPI Device ID is mapped to SPI_SS_B1 with the GPIO_9_AL pin.  */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968380GERG =
{
   "968380GERG",
   {
      {SPI_DEV_0,  BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B1 with a dedicated pin. */
      {SPI_DEV_0,  BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B2 with a dedicated pin. */
      {SPI_DEV_0,  BP_NOT_DEFINED}     /* This SPI Device ID is mapped to SPI_SS_B3 with a dedicated pin. */
   },
   {
      BP_NOT_DEFINED,    /* FXS1 reset pin, mapped to the FXS1 reset pin on daughter board. */
      BP_NOT_DEFINED,    /* FXS2 reset pin, mapped to the FXS2 reset pin on daughter board. */
   ...
   BP_NOT_DEFINED,   /* DECT reset pin, 6838G_RG doesn't support DECT */
   BP_NOT_DEFINED,   /* Relay1 control pin, 6838GERG doesn't support relay */
   BP_NOT_DEFINED,   /* Repay2 control pin, 6838GERG doesn't support relay */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968380EPRG =
{
   "968380EPRG",
   {
      {SPI_DEV_0,  BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B1 with a dedicated pin. */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968380FFHG =
{
   "968380FFHG",
   {
      {SPI_DEV_0,  BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B1 with a dedicated pin. */
...
VOICE_BOARD_PARMS_NEW g_voice_bcm968380FESFU =
{
   "968380FESFU",
   {
      {SPI_DEV_0,  BP_NOT_DEFINED},    /* This SPI Device ID is mapped to SPI_SS_B1 with a dedicated pin. */
...
static PVOICE_BOARD_PARMS_NEW g_VoiceBoardParms_new[]=
{
   ...
   &g_voice_bcm968380FSVG,
   &g_voice_bcm968380FSVE,
   &g_voice_bcm968380FSVGE,
