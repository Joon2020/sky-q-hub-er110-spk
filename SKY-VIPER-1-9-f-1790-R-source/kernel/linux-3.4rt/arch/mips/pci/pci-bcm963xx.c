...
/* defined(CONFIG_BCM96318) || defined(CONFIG_BCM96838) */
    ...
    if(kerSysGetPciePortEnable(1)){
        PCIEH_1_CPU_INTR1_REGS->maskClear = (
            PCIE_CPU_INTR1_PCIE_INTD_CPU_INTR |
            PCIE_CPU_INTR1_PCIE_INTC_CPU_INTR |
            PCIE_CPU_INTR1_PCIE_INTB_CPU_INTR |
            PCIE_CPU_INTR1_PCIE_INTA_CPU_INTR );
       ...
       /* setup outgoing mem resource window */
        PCIEH_1_MISC_REGS->cpu_2_pcie_mem_win0_base_limit = (((BCM_PCIE_MEM2_BASE+BCM_PCIE_MEM2_SIZE-1)&PCIE_MISC_CPU_2_PCI_MEM_WIN_LO_BASE_LIMIT_LIMIT_MASK) \
    	 																								|((BCM_PCIE_MEM2_BASE>>PCIE_MISC_CPU_2_PCI_MEM_WIN_LO_BASE_LIMIT_LIMIT_SHIFT)<<PCIE_MISC_CPU_2_PCI_MEM_WIN_LO_BASE_LIMIT_BASE_SHIFT));
    	 																									
        PCIEH_1_MISC_REGS->cpu_2_pcie_mem_win0_lo |= (BCM_PCIE_MEM2_BASE&PCIE_MISC_CPU_2_PCI_MEM_WIN_LO_BASE_ADDR_MASK);
    	 
    	 /* setup incoming DDR memory BAR(1) */
        PCIEH_1_RC_CFG_VENDOR_REGS->specificReg1 = PCIE_RC_CFG_VENDOR_SPECIFIC_REG1_ENDIAN_MODE_BYTE_ALIGN;
        PCIEH_1_MISC_REGS->rc_bar1_config_lo = ((DDR_UBUS_ADDRESS_BASE&PCIE_MISC_RC_BAR_CONFIG_LO_MATCH_ADDRESS_MASK) \
    	                                       | PCIE_MISC_RC_BAR_CONFIG_LO_SIZE_256MB);
    
        PCIEH_1_MISC_REGS->ubus_bar1_config_remap = PCIE_MISC_UBUS_BAR_CONFIG_ACCESS_EN;
    
        /* set device bus/func/func */
        PCIEH_1_PCIE_EXT_CFG_REGS->index = (BCM_BUS_PCIE1_DEVICE<<PCIE_EXT_CFG_BUS_NUM_SHIFT);
    
        /* setup class code, as bridge */
        PCIEH_1_BLK_428_REGS->idVal3 &= ~PCIE_IP_BLK428_ID_VAL3_CLASS_CODE_MASK;
        PCIEH_1_BLK_428_REGS->idVal3 |= (PCI_CLASS_BRIDGE_PCI << 8);
        /* disable bar0 size */
        PCIEH_1_BLK_404_REGS->config2 &= ~PCIE_IP_BLK404_CONFIG_2_BAR1_SIZE_MASK;
