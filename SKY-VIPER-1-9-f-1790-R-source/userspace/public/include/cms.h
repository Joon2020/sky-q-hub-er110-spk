...
#ifdef SKY
   CMSRET_MAXIMUM_NUMBER_OF_OBJECT = 9860, /**< maximum number of instances of an object exceeded */
#endif /* SKY */
} CmsRet;
...
// hijack pages are a bitmap of char, the value should be power of 2 ( i.e 1,2,4,8,16,32,64,128,256)
typedef struct {
 unsigned long st_size;
 char filename[16];
}Fileheader;

#define NO_CONNECTION_HIJACK 	1
#define FIRMWARE_UPGRADE_HIJACK 	2
#define BLOCK_SITES_HIJACK  4
#define SELF_HEAL_INITIAL_PAGE  8


#ifdef SKY_IPV6
/**
 * IPv6 address scope definition
 */
typedef enum _e_ipv6_addr_scope {
	E_IPV6_SCOPE_LINK_LOCAL = 0,
	E_IPV6_SCOPE_SITE_LOCAL,
	E_IPV6_SCOPE_UNIQUE_LOCAL,
	E_IPV6_SCOPE_GLOBAL
} e_ipv6_addr_scope;
#endif

/* Sky defined Semaphore id. */
#define SEM_KEY_LANSUBSYS_INIT        0xA551
#define SEM_KEY_LANSUBSYS_CONFIG_SYNC 0xA552
#define SEM_KEY_ACI_ACCESS_LOCK       0xA553

#ifdef SKY_EXTENDER
/* Fancy pattern to differentiate between factory default and non factory
 * default condition.
 */
#define BOOSTER2_NOT_FACTORY_DEF 0x1120
#define BOOSTER2_FACTORY_DEF     0x0120

// Factory default PSP key name. The size is sizeof(unsigned int)
#define CMS_FACTORY_DEF_PSP_KEY  "LanSubsysFacDef"

#ifdef SKY_EXTENDER_WFA_TODO
// Unique message data in delayed message
#define SKY_WPS_PIN_START_2_4   0xDCBA1
#define SKY_WPS_PIN_START_5_0   0xDCBA2
#endif // SKY_EXTENDER_WFA_TODO

#endif // SKY_EXTENDER

#ifdef SKY_MESH_SUPPORT
// Unique message data in delayed message
#define SKY_LAN_ACI_API_READY       0xABCD1
#define SKY_LAN_SUBSYSTEM_READY     0xABCD2
#define SKY_LAN_SUBSYSTEM_CFG_READY 0xABCD3
#endif

#ifdef CONFIG_SKY_ETHAN
#ifdef CONFIG_SKY_MODEL_ER110
#define LOG_FILE_NAME  "viper_logs.tar"
#elif defined(SKY_EXTENDER)
#define LOG_FILE_NAME  "booster_logs.tar"
#endif
#endif
