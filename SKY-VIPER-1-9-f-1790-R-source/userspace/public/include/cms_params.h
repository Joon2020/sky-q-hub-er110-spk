 ...
 * If 0, then no timeout.
 */
#ifdef SKY_SUPPORT_TRIALS
/* Timeout is increased to some large value so that it doesn't timeout often
 * and interfere with the system performance
 */
#define TELNETD_EXIT_ON_IDLE_TIMEOUT  600000000
#else
#define TELNETD_EXIT_ON_IDLE_TIMEOUT  600
#endif /* SKY_SUPPORT_TRIALS */
