...
/** Convert the given alphanumeric string to an equivalent numeric value.
 *  The alpha characters are replaced with their equivalent ASCII value
 *  and the numeric values are retained as such.
 *  E.g., ABC123SKY => 656667123837589
 *
 * @param alphaStr (IN)  Alphanumeric string to be converted.
 * @param convNum  (OUT) Buffer containing the converted numeric value.
 * @return CmsRet enum - success/failure status of the function execution.
 */
...
/** Given an IPv6 address string, return true if it is a valid IPv6
 *  Unique Local Address.
 *
 * @param address (IN) IPv6 address string.
 *
 * @return TRUE if the string is a valid IPv6 Unique Local Address.
 */
