...
#ifdef SKY 
/*
IPv6: Unable to access IPv6 enabled websites when WAN connection is up for the first time
Always returning LAN IPV6 address as 2a02:0c7a:fe10:7f00:

 cat /proc/net/if_inet6
2a020c7afe107f000000000000000001 0d 40 00 80      br0
00000000000000000000000000000001 01 80 10 80       lo
fe80000000000000a0fae04ea435b15e 13 0a 20 80   pppoa0
fe800000000000007e4ca5fffe89a1e0 12 40 20 80     atm0
fe800000000000007e4ca5fffe89a1e0 08 40 20 80     eth1
fd10dd7426de00007e4ca5fffe89a1e0 0d 40 00 80      br0
fe800000000000007e4ca5fffe89a1e0 0d 40 20 80      br0

we need to take the ULA address rather than global address since clients are requesting using ULA
ULA assignment prefix will be FC00::/7 

*/
      if (strstr(line, ifname) != NULL && ( strncmp(line,"fc",2) == 0 || strncmp(line,"fd",2) == 0 ) )
#else
