...
bs /bdmf/new system/init_cfg={wan_type=gbe,emac_mode={group_mode=sgmii,emac4_mode=rgmii,emac5_mode=sgmii},num_wan=1,num_lan=1,enabled_emac=emac0+emac4,wan_emac=emac0,switching_mode=none,ip_class_method=fc},cfg={mtu_size=1536}
