...
#ifdef SKY
#define ARP_SCAN_IP_ADDR_LEN  16 // length of IP address
#endif /* SKY */
...
#ifdef SKY   
   unsigned char dest_mac[ETH_ALEN];	/* destination hardware address */ 
#endif
} host_entry;
...
#else /* SKY */
void add_host_pattern(const char *, unsigned, const char*);
void add_host(const char *, unsigned, const char*);
#endif /* SKY */
