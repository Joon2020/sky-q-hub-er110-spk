				...
				int family)
{
	...
	const char *ipv4ipv6_delim = "::ffff:\0";
	...
	connptr->l3_family = family;


	connptr->l3_ipv4_ipv6_mapped = 0;
	if (AF_INET6 == family && strstr(string_addr, ipv4ipv6_delim)) {
		connptr->l3_ipv4_ipv6_mapped = 1;
	}
