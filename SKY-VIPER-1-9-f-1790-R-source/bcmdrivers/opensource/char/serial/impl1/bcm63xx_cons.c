...
#ifndef CONFIG_SKY_DEFAULT_CONSOLE_UART
#define CONFIG_SKY_DEFAULT_CONSOLE_UART 0
#endif
...
//    .write        = NULL,
    ...
    .index        = CONFIG_SKY_DEFAULT_CONSOLE_UART,
    .data        = &bcm63xx_reg,
};
...
{
#ifdef SKY
#if CONFIG_SKY_DEFAULT_CONSOLE_UART != 0 && CONFIG_SKY_DEFAULT_CONSOLE_UART != 1
	int n = flash_is_write_protected();
	bcm63xx_console.index = n != -1 ? n : 1;
#endif
#endif
