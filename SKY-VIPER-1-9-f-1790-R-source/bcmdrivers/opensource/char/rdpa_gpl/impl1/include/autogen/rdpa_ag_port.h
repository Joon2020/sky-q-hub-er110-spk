...
typedef enum {
    ...
    rdpa_port_attr_def_flow = 6, /* def_flow : RW : aggregate/44 classification_result(rdpa_ic_result_t ) : DS default flow classification. Wifi: last default flo */
    ...
    rdpa_port_attr_transparent = 11, /* transparent : RI : bool/1 : LAN Port  transparent Controll */
 ...
 *
 * Get LAN Port  transparent Controll.
 * \param[in]   mo_ port object handle or mattr transaction handle
 ...
 *
 * Set LAN Port  transparent Controll.
 * \param[in]   mo_ port object handle or mattr transaction handle
