...
typedef enum {
    ...
    rdpa_system_attr_cfg = 1, /* cfg : RW : aggregate/19 system_config(rdpa_system_cfg_t) : System Configuration that can be changes in run-time */
    rdpa_system_attr_sw_version = 2, /* sw_version : R : aggregate/5 sw_version(rdpa_sw_version_t) : software version */
    ...
    rdpa_system_attr_tpid_detect = 5, /* tpid_detect : RWF : aggregate/4[6(rdpa_tpid_detect_t)] system_tpid_detect_cfg(rdpa_tpid_detect_cfg_t) : TPID Detect */
