...
typedef enum {
    ...
    rdpa_gem_attr_ds_def_flow = 5, /* ds_def_flow : RW : aggregate/44 classification_result(rdpa_ic_result_t ) : downstream default flow configuration */
    rdpa_gem_attr_port_action = 6, /* port_action : RWF : aggregate/5[35(rdpa_if)] gem_port_action(rdpa_gem_port_action_t) : Per port vlan action configuration */
