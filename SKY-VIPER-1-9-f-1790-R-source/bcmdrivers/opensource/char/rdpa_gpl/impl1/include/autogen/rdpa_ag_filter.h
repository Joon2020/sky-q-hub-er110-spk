...
typedef enum {
    ...
    rdpa_filter_attr_oui_val = 2, /* oui_val : RWF : number/4[140(filter_oui_val_key)] : MAC Address OUI filter, Value */
    rdpa_filter_attr_tpid_vals = 3, /* tpid_vals : RW : aggregate/4 filter_tpid_vals(rdpa_filter_tpid_vals_t) : TPID filter, Values */
    rdpa_filter_attr_entry = 4, /* entry : RWF : aggregate/8[700(filter_key)] filter_ctrl(rdpa_filter_ctrl_t) : Entry - Filter on a Port */
    rdpa_filter_attr_stats = 5, /* stats : RF : number/2[40(filter_stats_key)] : Drop statistics */
