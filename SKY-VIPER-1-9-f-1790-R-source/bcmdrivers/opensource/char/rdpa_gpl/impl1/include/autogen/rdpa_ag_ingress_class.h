...
typedef enum {
    ...
    rdpa_ingress_class_attr_flow = 4, /* flow : RWADF : aggregate/132[255] class_info(rdpa_ic_info_t ) : Ingress class flow entry */
    ...
    rdpa_ingress_class_attr_port_action = 6, /* port_action : RWF : aggregate/5[126(port_action_key)] port_action(rdpa_port_action_t) : Per egress port action */
