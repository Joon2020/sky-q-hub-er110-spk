...
typedef enum {
    ...
    rdpa_iptv_attr_channel_request = 3, /* channel_request : WAD : aggregate/96 iptv_channel_request(rdpa_iptv_channel_request_t) : Request to view the channel (reflecti */
    rdpa_iptv_attr_channel = 4, /* channel : RF : aggregate/104[1024] iptv_channel(rdpa_iptv_channel_t) : IPTV channels table */
