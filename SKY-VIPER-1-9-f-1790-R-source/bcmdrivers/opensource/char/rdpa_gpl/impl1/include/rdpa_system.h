...
typedef struct
{
    ...
    rdpa_ext_sw_hdr_type hdr_type;      /**< External switch port identification tag type */
...
typedef struct
{
    uint16_t val_udef; /** Value, User-Defined */

    bdmf_boolean otag_en; /** Outer tag, Enabled flag */
    bdmf_boolean itag_en; /** Inner tag, Enabled flag */
